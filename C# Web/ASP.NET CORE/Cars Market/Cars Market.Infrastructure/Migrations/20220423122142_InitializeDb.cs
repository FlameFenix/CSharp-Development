        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SellerId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    SendToEmail = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    SendFromEmail = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Picture = table.Column<byte[]>(type: "varbinary(max)", maxLength: 2048000, nullable: false),
                    SellerId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AuthorPicture = table.Column<byte[]>(type: "varbinary(max)", maxLength: 2048000, nullable: false),
